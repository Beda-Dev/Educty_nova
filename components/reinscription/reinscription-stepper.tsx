...
const steps: Step[] = [
  {
    ...
    description: "Modification des données de l'élève",
  },
  {
    id: 2,
    title: "Informations scolaires",
    description: "Nouvelle classe et année",
  },
  {
    id: 3,
    title: "Tarification",
...
interface ReinscriptionStepperProps {
  currentStep: number
}

export function ReinscriptionStepper({ currentStep }: ReinscriptionStepperProps) {
