...
export function Step3Pricing({ onNext, onPrevious }: Step3Props) {
  ...
  }, [cashRegisterSessionCurrent, validatePayments, exceedsDiscountedPrice, appliedDiscount, confirmAndProceed, showDiscountConfirmModal])
                    ...
                    <SelectContent>
                      {availablePricing.map((pricing) => (
                        <SelectItem key={pricing.id} value={pricing.id.toString()}>
                          {pricing.label} - {parseFloat(pricing.amount).toLocaleString()} {currency}
                        </SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
          ...
          <div className="relative
            ...
            <div className="relative z-10">
              ...
              <div className="p-6 space-y-6">
                ...
                >
                  <p className="text-sm text-muted-foreground">
                    Une remise a été appliquée à cette réinscription :
                  </p>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2 text-muted-foreground">
                              ...
                              <span className="text-sm">Tarif {selectedPricing.label}</span>
                            </div>
