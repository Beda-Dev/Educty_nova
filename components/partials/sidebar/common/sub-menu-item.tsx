...
const SubMenuItem = ({ subItem, trans }: {
  ...
  return (
    <LockLink href={subItem.href} subItem={subItem} trans={trans}>
      <div
        className={cn(
          "text-sm capitalize  font-normal flex gap-3 items-center transition-all duration-150 rounded dark:hover:text-skyblue  ",
          {
            " text-skyblue   ": isLocationMatch(subItem.href, locationName),
