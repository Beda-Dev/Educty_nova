...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-[2px] text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      color: {
        default: "border-transparent bg-primary text-skyblue-foreground ",
        destructive:
      ...
      variant: {
        ...
        soft: "text-current bg-opacity-10  hover:text-skyblue-foreground",
      },
    },
    compoundVariants: [
      {
      ...
      // soft button variant
      {
        variant: "soft",
        color: "default",
        className: "text-skyblue hover:text-skyblue",
      },
      {
        variant: "soft",
        color: "info",
