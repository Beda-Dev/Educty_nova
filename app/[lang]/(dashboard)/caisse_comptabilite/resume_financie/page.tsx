...
import type { Student, Pricing, Installment, Payment } from "@/lib/interface"
...
export default function FinancialSummaryPage() {
  const { registrations, students, pricing, installements, payments, academicYearCurrent, settings } =
    useSchoolStore()
