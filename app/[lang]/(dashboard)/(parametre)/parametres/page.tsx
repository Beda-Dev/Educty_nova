  ...
  const menuItems = [
    {
      ...
      description: "Configuration de base du système et préférences",
    ...
    },
    {
      id: "pedagogy",
      title: "Pédagogie",
      description: "Gestion des programmes, classe , niveau , matières et évaluations",
              ...
              <TooltipProvider key={item.id} delayDuration={100}>
                <Tooltip>
                  ...
                  <TooltipContent side="top" className="bg-primary text-white">
                    <p>Cliquez pour accéder aux paramètres {item.title.toLowerCase()}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ))}
