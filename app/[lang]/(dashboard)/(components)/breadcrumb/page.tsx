    ...
    <div className="space-y-5">
      <Card title="Default Breadcrumb" code={defaultBreadCrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          <span className="text-skyblue">Breadcrumbs</span> is the main
          component, which is a wrapper for the other components and show as a
          breadcrumb component..{" "}
          <span className="text-skyblue">BreadcrumbItem</span> is the component
      ...
      <Card title="Disabled Breadcrumb" code={disabledBreadCrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          The <span className="text-skyblue">disabled </span> props helps
      ...
      <Card title="Sizes Breadcrumb" code={sizeBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          The <span className="text-skyblue">size </span> props helps
      ...
      <Card title="Color Breadcrumb" code={colorBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          The <span className="text-skyblue">variant </span> props helps
      ...
      <Card title="Style Breadcrumb" code={styleBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          The <span className="text-skyblue">styled </span> props helps
      ...
      <Card title="Underlines" code={underlinesBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          The <span className="text-skyblue">underlines </span> props helps
      ...
      <Card title="Border Radius" code={radiusBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          The <span className="text-skyblue">tailwind class </span> for
      ...
      <Card title="Routing" code={routingBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          The <span className="text-skyblue">href="/button"</span> property
      ...
      <Card title="With Icon" code={startIconBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          ...
          using the <span className="text-skyblue">startContent</span> and{" "}
          <span className="text-skyblue">endContent</span> props. The above
          example uses the <span className="text-skyblue">endContent</span> and{" "}
          <span className="text-skyblue">startContent</span> prop to add icons
      ...
      <Card title="Custom  Separator" code={customSeparator}>
        <p className="text-muted-foreground mb-5 text-sm">
          The <span className="text-skyblue">separator</span> props helps
      ...
      >
        <p className="text-muted-foreground mb-5 text-sm">
          ...
          <span className="text-skyblue">renderEllipsis</span> props to show
      ...
      <Card title="Controlled Breadcrumb" code={controlledBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          ...
          <span className="text-skyblue"> key and isCurrent </span> props can
      ...
      <Card title="Menu Type" code={menuTypeBreadcrumb}>
        <p className="text-muted-foreground mb-5 text-sm">
          On select any Item of <span className="text-skyblue">Breadcrumb </span> the single item will
