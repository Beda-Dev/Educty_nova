    ...
    <div className=" grid grid-cols-1 lg:grid-cols-2 gap-5">
      <Card title="Basic  Accordion" code={basicAccordion}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">collapsible</code> prop is used to
      ...
      <Card title="Accordion Without Arrow " code={accordionWithOutArrow}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">arrow</code> prop is used to hide
      ...
      <Card title="Accordion With Subtitle " code={accordionSubtitle}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">subtitle</code> is used to show a
      ...
      <Card title="Accordion With Border " code={accordionBorder}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">border</code> is used to show
      ...
      <Card title="Collapse Icon Accordion " code={collapseIconAccordion}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">icon</code> is used to change when
      ...
      <Card title="Accordion With Icon" code={accordionWithIcon}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">icon</code> is indicating the
          related topic.
        </p>
        <AccordionWithIcon />
      </Card>
      <Card title="Simple Accordion" code={simpleAccordion}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">Accordion</code> is basic accordion
      ...
      <Card title="Additional Actions" code={additionalActions}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">checkbox</code> is the action that
      ...
      <Card title="Accordion With Content" code={accordionWithContent}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">content </code> is the presentation
      ...
      <Card title="Custom Indicator" code={customIndicator}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-skyblue">indicator</code> that alternate the
