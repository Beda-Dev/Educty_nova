  ...
  return (
    <div className="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-6">
      ...
      <Card title="Input With Button" code={inputWithButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          Use <span className="text-skyblue">Button</span> component for button
        </p>
        <InputWithButton />
      </Card>
      ...
      <Card title="Input With Helper Text" code={inputWithHelperText}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          ...
          <span className="text-skyblue">supportive text</span> either below or
      ...
      <div className="col-span-2">
        <Card title="Sizes" code={inputSizes}>
          <p className="text-sm text-default-400 dark:text-default-600  mb-4">
            The <span className="text-skyblue">size</span> prop is used to
      ...
      <div className="col-span-2">
        <Card title="Colors" code={inputColors}>
          <p className="text-sm text-default-400 dark:text-default-600  mb-4">
            The <span className="text-skyblue">color</span> prop is used to
            ...
            . <br />
            Use <span className="text-skyblue">variant="flat"</span> prop to
            flat style.
          </p>
          <InputColors />
        </Card>
      ...
      <div className="col-span-2">
        <Card title="Variant" code={inputVariant}>
          <p className="text-sm text-default-400 dark:text-default-600  mb-4">
            The <span className="text-skyblue">variant</span> property is
