    ...
    <>
      {data.map((item, index) => (
        <div
          ...
          className={cn(
            "flex flex-col gap-1.5 p-2 rounded-l overflow-hidden bg-primary/10  items-start relative before:absolute before:left-1/2 before:-translate-x-1/2 before:bottom-1 before:h-[1px] before:w-8 before:bg-primary/50 dark:before:bg-primary-foreground before:hidden ",
            {
