...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!response.ok) {
      throw new Error(data.message || 'Erreur lors de la récupération des types de note');
    }
...
export async function POST(request: NextRequest) {
  try {
    ...
    const data = await response.json();
    if (!response.ok) {
      throw new Error(data.message || 'Erreur lors de la création du type de note');
    }
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const data = await response.json();
    if (!response.ok) {
      throw new Error(data.message || 'Erreur lors de la mise à jour du type de note');
    }
    return NextResponse.json(data, { status: 200 });
  } catch (error: any) {
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const data = await response.json();
    if (!response.ok) {
      throw new Error(data.message || 'Erreur lors de la suppression du type de note');
    }
    return NextResponse.json(data, { status: 200 });
  } catch (error: any) {
