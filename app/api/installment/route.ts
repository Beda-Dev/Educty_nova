...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!response.ok) {
      throw new Error(data.message || 'Erreur lors de la récupération des échéances');
    }
...
export async function POST(request: NextRequest) {
  try {
    ...
    const data = await response.json();
    if (!response.ok) {
      throw new Error(data.message || "Erreur lors de la création de l'échéance");
    }
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const data = await response.json();
    if (!response.ok) {
      throw new Error(data.message || "Erreur lors de la mise à jour de l'échéance");
    }
    return NextResponse.json(data, { status: 200 });
  } catch (error: any) {
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const data = await response.json();
    if (!response.ok) {
      throw new Error(data.message || "Erreur lors de la suppression de l'échéance");
    }
    return NextResponse.json(data, { status: 200 });
  } catch (error: any) {
